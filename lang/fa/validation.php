...
return [
    ...
    */
    ...
    |
    */
    'version_above_zero'        => 'مقدار :attribute باید بزرگتر از نسخه ۰.۰.۰ باشد.',
    'at_least_one_file_changed' => 'برای ارسال بروزرسانی می‌بایست حداقل یک فایل را تغییر داده باشید.',
    'custom'                    => [
        'attribute-name' => [
            'rule-name' => 'custom-message',
        ],
        'word_count'     => [
            'min' => 'تعداد کلمات نباید کمتر از :min کلمه باشد.',
            'max' => 'تعداد کلمات نباید بیشتر از :max کلمه باشد.',
        ],
    ],
